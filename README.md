...
Aplicação móvel para reconhecimento de dígitos escritos a mão utilizando redes neurais convolucionais.
Projeto utilizado como trabalho de conclusão de curso em Sistemas de informação.
